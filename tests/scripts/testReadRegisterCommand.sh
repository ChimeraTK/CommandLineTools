...
( flock 9 # lock for mtcadummys0
  ( flock 8 # lock for mtcadummys1
    ...
    bash -c '$0 read "(pci:mtcadummys0)" "" "#/0/60" 0 0 hex >> $1  2>&1' $mtca4u_executable $actual_console_output 
    ...
    bash -c '$0 read "(pci:mtcadummys0)" "" "#/2/0*16" >> $1  2>&1' $mtca4u_executable $actual_console_output 
    ...
    bash -c '$0 read "(pci:mtcadummys0)" "" "#/2/4*16" 1 2 >> $1  2>&1' $mtca4u_executable $actual_console_output 
